...
(Person :method :age) ; #function[clojure-walkthrough.cjia.ch08-xx/age--20738]

((Person :method :age)) ; 20
...
(shelly :greet "Nancy") ;; "Hello there, Nancy"

;; Referring to this (TBC)
...
(shelly :about 2) ; "I was born about 22 years ago"
...
(parent-class-spec '((extends Person)
                     (method age [] (* 2 9)))) ;; Person

(var map) ; #'clojure.core/map
...
(donna :greet "Shelly") ;; "Hello, Shelly"

(donna :age) ;; 18

;; (donna :about 3) ;; Unable respond to :about ..
